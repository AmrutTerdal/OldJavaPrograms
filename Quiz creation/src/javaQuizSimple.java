...
class javaQuizSimple extends JFrame implements ActionListener  
{  
    JLabel l;  
    ...
    {  
        ...
        {  
        if(e.getActionCommand().equals("Result"+y))  
        {  
            if(check())  
                count=count+1;  
            now=current;  
    ...
    {  
        new javaQuizSimple(" Test Of Java");  
    }  
}  
